...
const getProductByDate = asyncHandler(async (req, res) => {
    //await console.log(req.body.cardDate);
    // const product = await Product.find({});

    let cardDate = new Date(req.query.cardDate);
    cardDate.setHours(0, 0, 0, 0);

    let newCardDate = new Date();
    newCardDate.setDate(cardDate.getDate() + 1);
    newCardDate.setHours(0, 0, 0, 0);
