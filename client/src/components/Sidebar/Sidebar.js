 ...
 */}
                        ...
                        <hr className="my-4 md:min-w-full" />
                        <button
                            className="bg-blue-500 hover:bg-blue-700 text-white active:bg-blue-600 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                            type="button"
                            onClick={onLogOut}
                        >
                            Logout
